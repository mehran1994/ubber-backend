...
//         this.date = new Date();
//         this.accessExpiresAt = +this.date + (+this.accessOptions.expiresInSeconds * 1000);
//         this.refreshExpiresAt = +this.date + (+this.refreshOptions.expiresInSeconds * 1000);
...
//             if (decoded.accessExpiresAt > +new Date()) return TokenAvailabilityTypeEnum.AVAILABLE;
//             if (decoded.accessExpiresAt < +new Date() && decoded.refreshExpiresAt > +new Date()) return TokenAvailabilityTypeEnum.EXPIRED;
